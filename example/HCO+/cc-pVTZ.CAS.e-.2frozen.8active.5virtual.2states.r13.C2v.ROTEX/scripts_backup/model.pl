...
%model = (
  ...
  'molecule',    "HCOX",              # Used only for directory and descriptions
  'atoms',        ["O", "H", "C"],   # All atoms must be specified
  'nelectrons',     14,              # number of target electrons
  ...
  #                A1B1B2A2
  'frozen_orbs',   [2,0,0,0], # C2v, which orbitals for each symmetry to use as frozen,
  'active_orbs',   [4,2,2,0], # C2v, which orbitals for each symmetry to use as active,
  'virtual_orbs',  [3,1,1,0], # which orbitals for each symmetry to use as virtual,
